...
?>
<div class="qWrap">
<br/><p><h1> Add Questions </h1></p><hr/><br/><br/>
<?php if($alert['msg'] != ''){ ?>
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
          <form method="post" action="">
             ...
             <p><input type="submit" style="margin: auto;display: block;" class="btn btn-sm btn-primary" name="addQuestion" value="Add Question" /></p>
          </form>
      </div>
    </div>
</div>
